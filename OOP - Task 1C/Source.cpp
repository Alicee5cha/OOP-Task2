...
void createHardcodedTestData()
{
	...
	// Create some users
	Player* u1 = new Admin("Alice", "password", "2018-06-16",1000);
	Player* u2 = new Player("Bob", "password", "2018-09-19",100);
	Player* u3 = new Player("Charlie", "password", "2018-09-24",150);

	// With some games in their library
	u1->getLibrary().addInFront(new LibraryItem("2018-06-17", app.GetStore().games[7]));
	u1->getLibrary().addAtEnd(new LibraryItem("2018-06-18", app.GetStore().games[1]));
	u2->getLibrary().addInFront(new LibraryItem("2018-09-19", app.GetStore().games[2]));
	u2->getLibrary().addAtEnd(new LibraryItem("2018-09-19", app.GetStore().games[3]));
	u3->getLibrary().addInFront(new LibraryItem("2018-09-24", app.GetStore().games[3]));
	u3->getLibrary().addAtEnd(new LibraryItem("2018-09-30", app.GetStore().games[6]));
